jsPsych.plugins["view"] = (function() {
        ...
        plugin.trial = function(display_element, trial) {
                ...
                $(document.getElementById("timer")).on("click", function () {
                        ...
                        if (instructions != "") {
                                ...
                                display_element.append($("<p>", {
                                        ...
                                        "css": {
                                                ...
                                                "width": "100%",
                                                //"height": 30,
                                                //"height": 100, // height of instructions hard-coded for practice trials
                        ...
                        layout.append(makeTable(nFirms, random_order_stocks, names, false));
                        ...
                        for (var i = 0; i < nFirms+1; i++) NPR_plot.push([]);
